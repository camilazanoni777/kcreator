...
export default function HeroCard({
  ...
  return (
    <div className={cn("relative overflow-hidden rounded-[36px] border border-primary/20 p-6 shadow-panel sm:p-8", className)}>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(139,92,246,0.12),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(246,216,240,0.24),transparent_28%)] dark:bg-[radial-gradient(circle_at_top_right,rgba(148,163,255,0.14),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(214,159,196,0.14),transparent_30%)]" />
          ...
          {progressLabel != null && progressValue != null && (
            <div className="surface-tile p-4 backdrop-blur-sm">
              <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="rounded-full bg-iris-100 px-3 py-1 text-xs font-semibold text-iris-700 dark:bg-[hsl(var(--surface-soft)/0.96)] dark:text-[hsl(var(--text-primary))]">
                  {progressValue}%
                </div>
              </div>
