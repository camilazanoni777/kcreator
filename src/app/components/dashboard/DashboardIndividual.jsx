    ...
    <div className="min-h-screen px-4 pb-12 pt-8 sm:px-8">
      ...
      <section className="mt-10">
        ...
        <div className="grid gap-4 xl:grid-cols-3">
          <BentoCard title="Prioridades" icon={Sparkles} eyebrow="Hoje e próximos passos" variant="accent">
          ...
          <BentoCard title="Financeiro" icon={WalletCards} eyebrow="Resumo do mês" variant={saldo >= 0 ? 'success' : 'danger'}>
            <div className="space-y-3">
          ...
          <BentoCard title="Estado do dia" icon={HeartPulse} eyebrow="Ritmo e energia">
      ...
      <section className="mt-10">
        ...
        <div className="grid gap-4 xl:grid-cols-2">
          <BentoCard title="Metas em andamento" icon={Target} eyebrow="Progressão do ciclo">
          ...
          <BentoCard title="Creator Studio" icon={Lightbulb} eyebrow="Snapshot rápido" variant="studio">
