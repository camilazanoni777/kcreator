  ...
  "inline-flex items-center rounded-full border px-2.5 py-1 text-[11px] font-semibold tracking-[0.04em] transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-transparent bg-rouge-500 text-destructive-foreground shadow-sm hover:bg-rouge-600",
        outline: "border-border/80 bg-[hsl(var(--surface-elevated)/0.9)] text-foreground shadow-soft",
      },
    },
    defaultVariants: {
      variant: "default",
