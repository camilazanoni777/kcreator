          ...
          <div className="space-y-3">
            {metas.map((m) => {
              ...
              return (
                <div
                  key={m.id}
                  className={`space-y-3 rounded-2xl border bg-[linear-gradient(145deg,hsl(var(--surface-elevated)/0.96),hsl(var(--surface)/0.9))] p-4 shadow-soft ${
                      ...
                      <div className="flex flex-col gap-3">
                        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                          ...
                          <div className="grid grid-cols-3 gap-2 lg:min-w-[360px]">
                            <div className="surface-tile rounded-2xl px-3 py-2 text-center">
                        ...
                        <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
                          <div className="space-y-2">
                            ...
                            <div className="rounded-[20px] border border-border/70 bg-[hsl(var(--surface-elevated)/0.94)] p-1 shadow-soft">
