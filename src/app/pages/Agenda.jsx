        ...
        <div className="space-y-4">
          ...
          >
            <div className="space-y-4">
                  ...
                  <div className="max-h-[28rem] space-y-2 overflow-y-auto pr-1">
                    {selectedDayTasks.length === 0 ? (
                      ...
                      selectedDayTasks.map((task) => (
                        <div key={task.id} className="rounded-[18px] border border-border/70 bg-secondary/35 px-3 py-2">
                          <p className="truncate text-sm font-semibold text-foreground">
                            {task.descricao}
                          </p>
                          <p className="mt-1 text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
              ...
              <div className="overflow-hidden rounded-[30px] border border-border/80 bg-border/60 shadow-soft">
                            ...
                            <div className="space-y-2">
                              ...
                              {dayTasks.length > VISIBLE_TASKS_PER_DAY ? (
                                <button
                                  ...
                                  className="inline-flex items-center rounded-full bg-secondary/70 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-foreground/70 transition-colors hover:bg-secondary"
                                >
